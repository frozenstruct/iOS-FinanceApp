...
class GRLineView: UIView {
    ...
    func addLabels() {
        ...
        setupLabel(
            inputLabel: titleLabel,
            labelText: "Profit & Loss Breakdown",
            fontString: "Avernir Next Regular",
            fontSize: 15
        )
